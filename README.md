...
```text
WhatsApp-AutoBOT-Extension-survey/
...
3. Click **Load unpacked** and select the `WhatsApp-AutoBOT-Extension-survey` folder of this project.
...
1. Navigate to the `backend-php` folder.
2. Upload the contents to your server.
3. Point your domain/subdomain document root to `public/`.
4. Rename `.env.example` to `.env` and configure your:
   - Supabase Credentials
   - Groq/OpenAI API Keys
   - JWT Secret
5. Run the SQL migrations found in `migrations/` in your Supabase SQL Editor.
